 ...
 *  
 *  DO NOT EDIT THIS FILE   (ctime_options.c)
 *  
 *  It has been AutoGen-ed  Tuesday April 27, 2004 at 11:51:02 PM CEST
 *  From the definitions    ctime_options.def
...
#endif
tSCC zCopyright[] =
       "ctime copyright (c) 2002 Upwatch BV, all rights reserved";
...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Define the Ctime Option Descriptions.
 */
...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Define the Ctime Option Environment
 */
tSCC   zPROGNAME[]   = "CTIME";
tSCC   zUsageTitle[] =
"ctime - commandline version of the ctime function call - Ver. 0.90\n\
...
tSCC   zExplain[]     = "\n\n";
tSCC    zDetail[]     = "\n\
ctime acts just like ctime(). Give it a the number of seconds\n\
since 1 jan 1970, and it prints out the time\n";
tSCC    zFullVersion[] = CTIME_FULL_VERSION;

tOptions ctimeOptions = {
